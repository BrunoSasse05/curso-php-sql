...
<ul>
    ...
    <li>
        ...
        <br> Quando realizado um saque, deverá ser registrado no array de operacoes para conferência do extrato (que devera ser um arquivo json de nome "operacoes.json")
    </li>
    <li>
